...
if (isset($invoice) && $invoice) {
    ...
    if ($promised_to_cancel)
        $can_customize = false;
}

// make all package subscribe/select link open in top most window
$subscribe_link_target = 'target="_top"';
?>
...
<div class=" panel_s tw-p-4 tw-py-2
    ...
    <div class="panel_footer tw-flex tw-justify-center tw-mt-4">
        ...
        <a href="<?= base_url('clients/packages/' . $package->slug . '/select'); ?>" <?= $subscribe_link_target; ?>
        ...
        <div class="tw-flex tw-flex-col">
            ...
            <a href="<?= base_url('clients/packages/' . $invoice->slug . '/select'); ?>" <?= $subscribe_link_target; ?>
        ...
        <a onclick="return confirm('<?= perfex_saas_ecape_js_attr(_l('perfex_saas_upgrade_confirm_text')); ?>')"
            href="<?= base_url('clients/packages/' . $package->slug . '/select'); ?>" <?= $subscribe_link_target; ?>
