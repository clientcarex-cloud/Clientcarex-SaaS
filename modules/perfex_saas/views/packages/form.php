    ...
    <div class="content">
        <div class="row">
            <div class="col-md-12">
                ...
                <?= form_open($this->uri->uri_string(), ['id' => 'packages_form', 'class' => 'tw-mb-8']); ?>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="advance-settings hidden">
                                    ...
                                    <div class="auto_remove_inactive_instance deps">
                                        <?= render_input('metadata[auto_remove_inactive_instance_days]', _l('perfex_saas_auto_remove_inactive_instance_days') . ' ' . perfex_saas_form_label_hint('perfex_saas_auto_remove_inactive_instance_days_hint'), $package->metadata->auto_remove_inactive_instance_days ?? 30, 'number', ['min' => PERFEX_SAAS_MINIMUM_AUTO_INSTANCE_REMOVE_GRACE_PERIOD]); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="btn-bottom-toolbar text-right">
                        <button type="submit" data-loading-text="<?= _l('perfex_saas_saving...'); ?>"
                            data-form="#packages_form" class="btn btn-primary"><?= _l('save'); ?></button>
                    </div>
                    <!-- End submit button -->
                </div>
