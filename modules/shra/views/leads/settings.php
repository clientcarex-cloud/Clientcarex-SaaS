            ...
            <div class="shra-card shra-mt">
                ...
                <div class="shra-card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4"><div class="form-group"><label>Unpaid join registration becomes a lead after (hours)</label><input type="number" name="shra_join_reclaim_hours" class="form-control" value="<?php echo html_escape(get_option('shra_join_reclaim_hours')); ?>" min="0" placeholder="48"><span class="help">Everyone who registers on the join page is also captured as an assigned lead. If no payment arrives (online or at the desk) within this window, the rider entry is removed and only the lead remains. Blank = 48 h. Set 0 to keep unpaid registrations as riders.</span></div></div>
                    </div>
                    <div class="row">
