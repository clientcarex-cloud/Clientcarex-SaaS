...
<div class="content">
    ...
    <form method="get" class="shra-toolbar">
        ...
        <label class="shra-pill" style="cursor:pointer;margin:0"><input type="checkbox" name="due" value="1" <?php echo $filters['due'] ? 'checked' : ''; ?> style="margin:0" onchange="this.form.submit()"> Balance due only</label>
