            ...
            <div class="shra-card">
                ...
                <div class="shra-card-body" style="border-top:1px solid var(--line)">
                    <div class="shra-kv">
                        ...
                        <div class="full"><div class="k">Terms &amp; conditions</div><div class="v"><?php echo $r->terms_accepted ? '<i class="fa fa-check" style="color:var(--green)"></i> Accepted by ' . html_escape($r->terms_accepted_by) . ($r->terms_accepted_at ? ' on ' . shra_datetime($r->terms_accepted_at) : '') : '<span style="color:var(--red)">Not accepted</span>'; ?></div></div>
                        <div><div class="k">Registered</div><div class="v"><?php echo shra_datetime($r->created_at); ?></div></div>
            ...
            <div class="shra-card">
                ...
                <div class="shra-table-wrap"><table class="shra-table">
                    ...
                    <?php foreach ($enrollments as $e) { $pct = $e->sessions_total ? round($e->sessions_used / $e->sessions_total * 100) : 0; ?>
                        <tr>
                            <td class="strong"><?php echo html_escape($e->package_name); ?> <span class="shra-muted" style="font-weight:400">· <?php echo $e->audience; ?></span><span class="sub"><?php echo html_escape($e->enrollment_no); ?> · <?php echo _d($e->created_at); ?><?php echo $e->expires_at ? ' · valid till ' . _d($e->expires_at) : ''; ?><?php echo $e->schedule ? ' · ' . html_escape($e->schedule) : ''; ?></span></td>
