...
<div class="content">
    ...
    <div class="shra-stats">
        ...
        <div class="shra-stat"><div class="shra-stat-icon"><i class="fa-solid fa-indian-rupee-sign"></i></div><div class="shra-stat-label">Collected today</div><div class="shra-stat-value"><?php echo shra_money($summary['revenue_today']); ?></div><div class="shra-stat-sub"><?php echo shra_money($summary['revenue_month']); ?> this month</div></div>
