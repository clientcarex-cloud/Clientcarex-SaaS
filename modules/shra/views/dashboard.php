...
<div class="content">
    ...
    <?php if (!empty($leads)) { ?>
    <div class="shra-stats" style="margin-top:-8px">
        <a class="shra-stat" href="<?php echo admin_url('shra/shra_leads?scope=all&stage=open'); ?>"><div class="shra-stat-icon"><i class="fa-solid fa-phone-volume"></i></div><div class="shra-stat-label">Open leads</div><div class="shra-stat-value"><?php echo (int) $leads['open_leads']; ?></div><div class="shra-stat-sub"><?php echo (int) $leads['new_month']; ?> new this month</div></a>
        <a class="shra-stat" href="<?php echo admin_url('shra/shra_leads?scope=all&overdue=1'); ?>"><div class="shra-stat-icon"><i class="fa-solid fa-exclamation"></i></div><div class="shra-stat-label">Overdue follow-ups</div><div class="shra-stat-value" style="color:<?php echo $leads['overdue'] ? 'var(--red)' : 'inherit'; ?>"><?php echo (int) $leads['overdue']; ?></div><div class="shra-stat-sub">need a call now</div></a>
        <a class="shra-stat" href="<?php echo admin_url('shra/shra_leads/visits'); ?>"><div class="shra-stat-icon"><i class="fa-solid fa-calendar-check"></i></div><div class="shra-stat-label">Weekend visits</div><div class="shra-stat-value"><?php echo (int) $leads['weekend_visits']; ?></div><div class="shra-stat-sub">booked for Sat &amp; Sun</div></a>
        <a class="shra-stat" href="<?php echo admin_url('shra/shra_leads/team'); ?>"><div class="shra-stat-icon"><i class="fa-solid fa-trophy"></i></div><div class="shra-stat-label">Leads → revenue</div><div class="shra-stat-value" style="font-size:22px"><?php echo shra_money($leads['revenue_month']); ?></div><div class="shra-stat-sub"><?php echo (int) $leads['won_month']; ?> joined<?php echo !empty($leads['top_agent']) ? ' · top: ' . html_escape($leads['top_agent']->name) : ''; ?></div></a>
    </div>
    <?php } ?>
