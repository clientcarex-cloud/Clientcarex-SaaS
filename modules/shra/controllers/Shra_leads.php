...
class Shra_leads extends AdminController
{
    ...
    public function settings()
    {
        ...
        if ($this->input->post()) {
            ...
            foreach (['shra_lead_sla_minutes', 'shra_lead_stale_days', 'shra_lead_phone_country', 'shra_lead_repeat_credit_months', 'shra_lead_visit_slots', 'shra_lead_lost_reasons', 'shra_lead_payment_methods', 'shra_lead_wa_templates', 'shra_lead_wa_copy_msg', 'shra_lead_wa_links',
