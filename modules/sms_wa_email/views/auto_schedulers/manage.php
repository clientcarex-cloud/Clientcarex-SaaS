...
<style>
    ...
    .ccx-btn-save { padding: 9px 22px; border-radius: 10px; font-size: 13.5px; font-weight: 600; background: linear-gradient(135deg, #8b5cf6, #6d28d9); color: #fff; border: none; cursor: pointer; transition: all 0.2s ease; box-shadow: 0 2px 8px rgba(139, 92, 246, 0.3); text-decoration: none !important; display: inline-flex; align-items: center; gap: 8px; }
    .ccx-btn-save:hover { transform: translateY(-1px); box-shadow: 0 4px 14px rgba(139, 92, 246, 0.4); color: #fff; }
</style>
            ...
            <div class="col-md-12">
                <div class="ccx-page-header" style="justify-content: space-between;">
                    <div style="display: flex; align-items: center; gap: 14px;">
                        ...
                        <div>
                            <h4>Auto Schedulers</h4>
                            <p>Daily recurring message schedulers with time-based cycles.</p>
                        </div>
                    </div>
                    <div style="display: flex; gap: 10px;">
                        <?php if (sms_wa_email_can('campaigns')) { ?>
                        <a href="<?php echo admin_url('sms_wa_email/campaigns'); ?>" class="btn btn-default" style="border-radius: 10px; padding: 9px 18px; font-weight: 600;">
                            <i class="fa fa-bullhorn"></i> Campaigns
                        </a>
                        <?php } ?>
                        <a href="<?php echo admin_url('sms_wa_email/auto_schedulers/create'); ?>" class="ccx-btn-save">
                            <i class="fa fa-plus"></i> New Auto Scheduler
                        </a>
                    </div>
                </div>
...
<script>
    $(function(){
        initDataTable('.table-auto-schedulers', admin_url + 'sms_wa_email/auto_schedulers', undefined, undefined, 'undefined', [0, 'desc']);
    });
</script>
</body>
</html>
