...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(WIKI_ASSETS_PATH . '/css/mindmap.css'); ?>?v=<?php echo time(); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(WIKI_ASSETS_PATH . '/css/mindmap-import.css'); ?>?v=<?php echo time(); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(WIKI_ASSETS_PATH . '/css/mindmap-toolbar.css'); ?>?v=<?php echo time(); ?>">
</head>
<body>
    ...
    <div class="navbar-bottom-builder">
        ...
        <a href="javascript:void(0)" id="mmImportTrigger" class="mm-import-trigger" title="Import text to mind map">
    ...
    <script>
        ...
        const MINDMAP_BACK_URL = "<?php echo $back_url; ?>";
    ...
    <script src="<?php echo base_url(WIKI_ASSETS_PATH . '/js/mindmap.js'); ?>?v=<?php echo time(); ?>"></script>
    <script src="<?php echo base_url(WIKI_ASSETS_PATH . '/js/mindmap-import.js'); ?>?v=<?php echo time(); ?>"></script>
    <script src="<?php echo base_url(WIKI_ASSETS_PATH . '/js/mindmap-toolbar.js'); ?>?v=<?php echo time(); ?>"></script>
</body>
</html>